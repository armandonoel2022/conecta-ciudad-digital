    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 p-4 animate-fade-in">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4 text-white mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">GUÍA DE COMUNICACIÓN</h1>
            <p className="text-white/80">Aprende a comunicarte mejor</p>
          </div>
        </div>
          ...
          <div className="flex items-center justify-center h-64">
            <Card className="w-full text-center border-none shadow-none">
              <CardHeader>
                ...
                <CardTitle className="mt-4 text-2xl text-gray-800">Guía de Comunicación</CardTitle>
